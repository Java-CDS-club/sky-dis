 ...
 * @generated
 */
public class RprSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case RprPackage.WORLD: {
                World world = (World)theEObject;
                T result = caseWorld(world);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RprPackage.ENTITY: {
                Entity entity = (Entity)theEObject;
                T result = caseEntity(entity);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RprPackage.ENTITY_ID: {
                EntityId entityId = (EntityId)theEObject;
                T result = caseEntityId(entityId);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RprPackage.WORLD_LOCATION: {
                WorldLocation worldLocation = (WorldLocation)theEObject;
                T result = caseWorldLocation(worldLocation);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RprPackage.ORIENTATION: {
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>World Location</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>World Location</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseWorldLocation(WorldLocation object) {
        return null;
    }
