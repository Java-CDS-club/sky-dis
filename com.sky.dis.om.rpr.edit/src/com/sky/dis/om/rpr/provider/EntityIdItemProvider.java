...
/**
 * This is the item provider adapter for a {@link com.sky.dis.om.rpr.EntityId} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityIdItemProvider
     ...
     * @generated
     */
    public EntityIdItemProvider(AdapterFactory adapterFactory) {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_EntityId_site_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_EntityId_site_feature", "_UI_EntityId_type"),
                 RprPackage.Literals.ENTITY_ID__SITE,
                 true,
                 false,
                 false,
    ...
    protected void addHostPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_EntityId_host_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_EntityId_host_feature", "_UI_EntityId_type"),
                 RprPackage.Literals.ENTITY_ID__HOST,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/EntityId"));
    }
    ...
    public String getText(Object object) {
        ...
        return getString("_UI_EntityId_type") + " " + entityId.getSite();
    }
