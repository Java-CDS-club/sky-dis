...
/**
 * This is the item provider adapter for a {@link com.sky.dis.om.rpr.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 RprPackage.Literals.ENTITY__NAME,
                 false,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(RprPackage.Literals.ENTITY__ENTITY_ID);
            childrenFeatures.add(RprPackage.Literals.ENTITY__WORLD_LOCATION);
            childrenFeatures.add(RprPackage.Literals.ENTITY__ORIENTATION);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (RprPackage.Literals.ENTITY__ENTITY_ID,
                 RprFactory.eINSTANCE.createEntityId()));

        newChildDescriptors.add
            (createChildParameter
                (RprPackage.Literals.ENTITY__WORLD_LOCATION,
                 RprFactory.eINSTANCE.createWorldLocation()));

        newChildDescriptors.add
            (createChildParameter
                (RprPackage.Literals.ENTITY__ORIENTATION,
                 RprFactory.eINSTANCE.createOrientation()));
    }
